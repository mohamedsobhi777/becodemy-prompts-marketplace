    ...
    return (
        <Card radius="lg" className='w-full md:w-[31%] 2xl:w-[23%] max-h-[410px] p-4 bg-[#130f23] m-3'>
            ...
            <Link href="/shop/124" className='w-full'>
                <Button className={'mb-3 w-full text-white bg-transparent border border-[#16c252] hover:bg-[#15c252] hover:text-black duration-300 transition-opacity font-Inter font-[600]'}>
                    Get Prompts
                </Button>
            </Link>
        </Card>
