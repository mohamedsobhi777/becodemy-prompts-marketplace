...
const Future = (props: Props) => {
    return (
        <div className='w-full relateive p-4 md:p-[unset] grid md:grid-cols-2'>
            ...
            <div className="col-span-1 w-full flex justify-center items-center">
                <div className="2xl:w-[60%]">
                    <Button className={`${styles.button} mb-[30px] nb-[30px] h-[37px] bg-[#12211f]`}>
                        Future
                    </Button>
                    <h5 className={`${styles.heading} !leading-[50px]`}>
